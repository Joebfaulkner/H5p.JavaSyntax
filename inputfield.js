...
(function (JavaSyntax) {
   ...
   */
  JavaSyntax.InputField = function (params, callbacks) {
    var that = this;
   ...
   */
  JavaSyntax.InputField.prototype.getIntroduction = function () {
   ...
   */
  JavaSyntax.InputField.prototype.getContent = function () {
    return this.content;
  };
   ...
   */
  JavaSyntax.InputField.prototype.getText = function () {
   ...
   */
  JavaSyntax.InputField.prototype.disable = function () {
   ...
   */
  JavaSyntax.InputField.prototype.enable = function () {
   ...
   * Enable the inputField.
   */
  JavaSyntax.InputField.prototype.focus = function () {
   ...
   */
  JavaSyntax.InputField.prototype.setText = function (previousState) {
   ...
   */
  JavaSyntax.InputField.prototype.computeRemainingChars = function () {
   ...
   */
  JavaSyntax.InputField.prototype.updateMessageChars = function () {
   ...
   */
  JavaSyntax.InputField.prototype.updateMessageSaved = function (saved) {
    if (!this.params.statusBar) {
      return;
    }
   ...
   */
  JavaSyntax.InputField.prototype.setMessageChars = function (message, important) {
    if (!this.params.statusBar) {
      return;
    }
