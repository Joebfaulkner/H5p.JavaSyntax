...
H5P.JavaSyntax = function ($, Question) 
{
    'use strict';
    ...
    */
    function JavaSyntax(config, contentId, contentData) 
    {
       // Initialize
    if (!config) {
        return;
    ...
    // Extends Question
    JavaSyntax.prototype = Object.create(Question.prototype);
    JavaSyntax.prototype.constructor = JavaSyntax;
  
    /**
     * Register the DOM elements with H5P.Question.
     */
    JavaSyntax.prototype.registerDomElements = function () 
    {
      const that = this;
      ...
      // Create InputField
      this.inputField = new H5P.JavaSyntax.InputField({
    ...
    */
    JavaSyntax.prototype.addButtons = function () {
    const that = this;
   ...
   */
   JavaSyntax.prototype.getInput = function (linebreakReplacement) {
   ...
   */
   JavaSyntax.prototype.handleInteracted = function (params) {
    params = params || {};
   ...
   */
   JavaSyntax.prototype.getAnswerGiven = function () {
   ...
   */
   JavaSyntax.prototype.getScore = function () {
   ...
   */
  JavaSyntax.prototype.getMaxScore = function () {
    // Return value is rounded because reporting module for moodle's H5P plugin expects integers
   ...
   */
   JavaSyntax.prototype.showSolutions = function () {
   ...
   */
   JavaSyntax.prototype.resetTask = function () {
    this.setExplanation();
    this.removeFeedback();
   ...
   */
   JavaSyntax.prototype.getXAPIData = function () {
    return {
   ...
   */
   JavaSyntax.prototype.isPassed = function () {
   ...
   * 
   */
  JavaSyntax.prototype.updateScore = function () {
    this.score = Math.min(this.computeScore(), this.getMaxScore());
  };
  /**
   * Handle the evaluation.
   */
   JavaSyntax.prototype.handleEvaluation = function () {
   ...
   */
  JavaSyntax.prototype.handleButtons = function (score) {
   ...
   * @param {number} score - Score the user received.
   */
  JavaSyntax.prototype.handleXAPI = function () {
   ...
   */
  JavaSyntax.prototype.createEssayXAPIEvent = function (verb) {
   ...
   */
  JavaSyntax.prototype.getxAPIDefinition = function () {
    const definition = {};
    definition.name = {};
    ...
    definition.description[this.languageTag] = this.params.taskDescription + JavaSyntax.FILL_IN_PLACEHOLDER;
    // Fallback for h5p-php-reporting, expects en-US
   ...
   */
  JavaSyntax.prototype.getXAPIAnswerEvent = function () {
   ...
   * @return {string} Title.
   */
  JavaSyntax.prototype.getTitle = function () {
    let raw;
    if (this.extras.metadata) {
      raw = this.extras.metadata.title;
    }
    raw = raw || JavaSyntax.DEFAULT_DESCRIPTION;
   ...
   */
  JavaSyntax.formatLanguageCode = function (languageCode) {
   ...
   */
  JavaSyntax.prototype.htmlDecode = function (input) {
   ...
   */
  JavaSyntax.prototype.getCurrentState = function () {
   ...
   * thai chars: \u0E00-\u0E7F
   */
  JavaSyntax.CHARS_WILDCARD = '[A-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u00FF\u0370-\u03FF\u0400-\u04FF\u3040-\u309F\u3040-\u30FF\u4E00-\u62FF\u6300-\u77FF\u7800-\u8CFF\u8D00-\u9FFF\u0E00-\u0E7F]';

  /** @constant {string}
   * Required to be added to xAPI object description for H5P reporting
   */
  JavaSyntax.FILL_IN_PLACEHOLDER = '__________';

  /** @constant {string} */
  JavaSyntax.DEFAULT_DESCRIPTION = 'JavaSyntax';

  /** @constant {string} */
  JavaSyntax.REGULAR_EXPRESSION_ASTERISK = ':::H5P-Essay-REGEXP-ASTERISK:::';
